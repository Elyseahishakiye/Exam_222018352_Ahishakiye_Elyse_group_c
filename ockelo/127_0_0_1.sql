...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2024 at 07:16 PM
...
-- Database: `bid`
--
CREATE DATABASE IF NOT EXISTS `bid` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bid`;
...
('root', '[{\"db\":\"bid\",\"table\":\"web\"},{\"db\":\"student\",\"table\":\"me\"}]');
...
('root', '2024-02-17 18:16:04', '{\"Console\\/Mode\":\"show\"}');
